...
private:
    ...
    int m_zeroPWMSignalInMicroseconds = min(max(chassis_defines::TRAXXAS_PWM_MICROSECONDS_ZERO + chassis_defines::steeringServoTrimInMicroseconds, chassis_defines::TRAXXAX_PWM_MICROSECONDS_MIN), chassis_defines::TRAXXAS_PWM_MICROSECONDS_MAX);
